...
Ini harga S3 di region **ap-southeast-1 (Singapore)**:
...
Dengan backup **64 GB**, aku cukup membayar sekitar **$1.60 per bulan** (sekitar Rp 25 ribuan) untuk S3 Standard. Dan semakin lama akan semakin murah karena otomatis dipindahkan ke Glacier, bahkan sampai ke Deep Archive — bisa menjadi cuma **$0.064 per bulan** (sekitar Rp 1,000-an). Udah kayak gratis kan rasanya wkwk.

Bandingin sama Google Drive yang $2.79/bulan untuk 100 GB, dan itu flat terus gabisa makin murah. Padahal data foto lama itu kan jarang kita akses — *why pay premium for something you barely touch*?
...
Penjelasan:
- `./zv1` → folder lokal hasil organize, zv1 because its from camera
- `s3://photo-backup-rifa/zv1` → lokasi di S3 bucket
